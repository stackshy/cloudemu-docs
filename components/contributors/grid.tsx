 ...
 * a podium medal (top three), full name, tier, and commit count beneath. No
 * boxes, no table — the faces carry it. Avatars pop in with a stagger and lift
 * on hover. Real data only.
 */
