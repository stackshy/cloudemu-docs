...
Emulates secret management: **SecretsManager** (AWS), **KeyVault** (Azure), **SecretManager** (GCP). Secret versions, rotation, and binary payloads are available through the Portable Go API.
