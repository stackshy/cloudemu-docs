...
Write and query log events against emulated **CloudWatch Logs** (AWS), **Log Analytics** (Azure), and **Cloud Logging** (GCP). Log groups, streams, and filter expressions are available through the Portable Go API.
