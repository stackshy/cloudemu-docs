---
title: Message Queue
description: Emulated message queues for SQS, Service Bus, and Pub/Sub
aws: SQS
azure: Service Bus
gcp: Pub/Sub
---
...
Send, receive, and delete messages on **SQS** (AWS), **Service Bus** (Azure), and **Pub/Sub** (GCP) with the real SDKs.
