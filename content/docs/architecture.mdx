...
type Provider struct {
    ...
    // ... plus IAM, Route53, ELB, ECR, SNS, EventBridge, ElastiCache,
    //     SecretsManager, CloudWatchLogs, Redshift, SageMaker,
    //     ResourceDiscovery, and more
}
```
...
For in-process tests, code that doesn't go through an SDK, or domains where SDK-compat isn't shipped yet (DNS, Load Balancer, Notification, Event Bus, Cache, Secrets, Logging), call the driver directly through the [Portable Go API](/docs/portable-api):
