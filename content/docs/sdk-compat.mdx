...
Nothing to mock. No cloud accounts. No bills. The same SDK calls you'd run against real cloud APIs hit a local `httptest.NewServer` and get back SDK-decodable responses.
